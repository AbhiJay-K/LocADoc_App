...
package com.locadoc_app.locadoc.Cognito;
/**
 * Copyright 2010-2014 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License").
...
public class CognitoSyncClientManager {
    ...
    private static final String IDENTITY_POOL_ID = "ap-southeast-1_Qng7tbYxG";
    ...
    public static void init(Context context) {
        credentialsProvider = new CognitoCachingCredentialsProvider(context, AppHelper.getPool().getUserPoolId(),
                REGION);
