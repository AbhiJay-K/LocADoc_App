...
public class ApplicationInstance implements BaseColumns {
    ...
    public static long updateRecord(String Instance)
    {
        ...
        long newRowId = ApplicationInstance.getDbHelper().WRITE.update(ApplicationInstance.TABLE_NAME,values,"_id=?",arg);
        return newRowId;
    }
    ...
    {
        String [] arg = {String.valueOf(1)};
        int deleted = ApplicationInstance.getDbHelper().WRITE.delete(ApplicationInstance.TABLE_NAME,"_id = ?",arg);
        return deleted;
    }
}
