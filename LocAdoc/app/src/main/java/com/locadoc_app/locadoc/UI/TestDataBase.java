...
import com.locadoc_app.locadoc.LocalDB.Password;
...
public class TestDataBase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //long l = Password.insert("testPassword","1231231");
        TextView t = (TextView) findViewById(R.id.test);
        String[] args={"testPassword2"};
        Cursor crs = Password.getDbHelper().getReadableDatabase().rawQuery("SELECT * FROM password WHERE password = ?", args);
        crs.moveToFirst();
